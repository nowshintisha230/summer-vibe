        ...
        <div className="grid grid-cols-2 min-h-[420px]">
          ...
          <div className="p-7 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2">
              <span className="text-amber-400 text-base tracking-wide">{stars}</span>
              <span className="text-sm text-gray-400">{product.rating} / 5</span>
            </div>

            {/* Price */}
            <div className="text-3xl font-medium text-gray-900">${product.price}.00</div>
            ...
            <div className="border-t border-gray-100 pt-3 mt-1">
              <table className="w-full text-sm">
                <tbody>
                  <tr><td className="text-gray-400 py-1">Stock</td><td className="text-right font-medium">{product.stock} units</td></tr>
                  <tr><td className="text-gray-400 py-1">Brand</td><td className="text-right font-medium">{product.brand}</td></tr>
                  <tr><td className="text-gray-400 py-1">Category</td><td className="text-right font-medium">{product.category}</td></tr>
                </tbody>
              </table>
            </div>
